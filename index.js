	...
	var FooterBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "a",
	        { className: "tab-item external" + ' ' + (this.props.data == '/' ? 'active' : ''), href: "#" },
	      ...
	      React.createElement(
	        "a",
	        { className: "tab-item external" + ' ' + (this.props.data == '/categories' ? 'active' : ''), href: "#/categories" },
	      ...
	      React.createElement(
	        "a",
	        { className: "tab-item external" + ' ' + (this.props.data == '/cart' ? 'active' : ''), href: "#/cart" },
	        React.createElement("span", { className: "icon icon-cart" }),
	        React.createElement(
	          "span",
	          { className: "tab-label" },
	          "购物车"
	      ...
	      React.createElement(
	        "a",
	        { className: "tab-item external" + ' ' + (this.props.data == '/user' ? 'active' : ''), href: "#/user" },
	        React.createElement("span", { className: "icon icon-friends" }),
	        React.createElement(
	          "span",
	          { className: "tab-label" },
	          "我的"
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('label', { className: 'icon icon-search' }),
	          React.createElement('input', { type: 'search', id: 'search', placeholder: '输入关键字...' })
	        )
	      )
	    );
	  }
	...
	var Cart = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Footer, { data: this.props.location.pathname })
	    );
	  }
	});
	module.exports = Cart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchButton = __webpack_require__(31);

	var CategoryList = __webpack_require__(126);
	...
	var Categories = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { id: 'header_search', className: 'h48' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SliderBox = __webpack_require__(130);

	var SearchButton = __webpack_require__(31);

	var SupplierBox = __webpack_require__(131);

	var ActiveImg = __webpack_require__(125);

	var HotProducts = __webpack_require__(127);

	var FooterBox = __webpack_require__(23);
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { id: 'slider' },
	        React.createElement(SliderBox, { url: Host + "/mall/api/v1/home/slider" })
	      ),
	      React.createElement(
	        'div',
	        { id: 'supplier' },
	        React.createElement(SupplierBox, null)
	      ),
	      React.createElement(
	        'div',
	        { id: 'active' },
	        React.createElement(ActiveImg, null)
	      ),
	      React.createElement(
	        'div',
	        { id: 'hot_products', 'class': 'hot-products' },
	        React.createElement(HotProducts, { url: Host + "/mall/api/v1/home/hot_products?per=3" })
	      ),
	      React.createElement(FooterBox, { data: this.props.location.pathname })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductShow = __webpack_require__(129);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement(ProductShow, { url: Host + "/mall/api/v1/products/" + this.props.params.id })
	      ),
	      React.createElement(Footer, { data: this.props.location.pathname })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Products = __webpack_require__(128);
	...
	var SupplierProducts = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { id: 'header_search', className: 'h40' },
	        React.createElement(SearchButton, null)
	      ),
	      React.createElement(
	        'div',
	        null,
	        React.createElement(Products, { url: Host + "/mall/api/v1/supplier/" + this.props.params.code + "/products" })
	      ),
	      React.createElement(Footer, { data: this.props.location.pathname })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RouterContext2 = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = __webpack_require__(118);

	var SupplierProduct = __webpack_require__(120);

	var ProductShow = __webpack_require__(119);

	var Categories = __webpack_require__(117);

	var Cart = __webpack_require__(116);

	var User = __webpack_require__(121);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(_reactRouter.Route, { path: '/supplier/:code', component: SupplierProduct }),
	    React.createElement(_reactRouter.Route, { path: '/products/:id', component: ProductShow }),
	    React.createElement(_reactRouter.Route, { path: '/product', component: SupplierProduct }),
	    React.createElement(_reactRouter.Route, { path: '/categories', component: Categories }),
	    React.createElement(_reactRouter.Route, { path: '/cart', component: Cart }),
	    React.createElement(_reactRouter.Route, { path: '/user', component: User })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActiveImg = React.createClass({
	  displayName: "ActiveImg",

	  render: function render() {
	    return React.createElement("img", { className: "w100 mt10", src: "src/images/banenr-md.png" });
	  }
	});

	module.exports = ActiveImg;
	...
	var CategoryRoot = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var categoryNodes = this.props.data.map(function (category) {
	      return React.createElement(
	        'li',
	        { onClick: clickHandler, key: category.id, 'data-category-id': category.id },
	        React.createElement(
	          'a',
	          null,
	          category.name
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(CategoryRoot, { data: this.state.data })
	      ),
	      React.createElement(
	        'div',
	        { className: 'category-content' },
	        React.createElement(CategoryContent, { data: this.state.data })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HotProductList = React.createClass({
	  displayName: 'HotProductList',

	  render: function render() {
	    var productNodes = this.props.data.map(function (product) {
	      return React.createElement(
	        'a',
	        { href: '#/products/' + product.id, key: product.id, className: 'hot-product-li' },
	        React.createElement(
	          'div',
	          null,
	          React.createElement(
	            'a',
	            null,
	            React.createElement('img', { className: 'w100', src: product.cover_url })
	          )
	        ),
	        React.createElement(
	          'div',
	...
	var HotProducts = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(HotProductList, { data: this.state.data })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'pro-img' },
	            React.createElement('img', { src: product.cover_url })
	          ),
	          React.createElement(
	            'div',
	...
	var Products = React.createClass({
	  ...
	  refresh: function refresh(number, page) {
	    $.ajax({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { id: 'infinite', className: 'content infinite-scroll infinite-scroll-bottom mt10', 'data-distance': '500' },
	        React.createElement(
	          'div',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'a',
	          { href: '#tab1', className: 'tab-link active button' },
	          '商品'
	        ),
	        React.createElement(
	          'a',
	          { href: '#tab2', className: 'tab-link button' },
	          '详情'
	        ),
	        React.createElement(
	          'a',
	          { href: '#tab3', className: 'tab-link button' },
	          '评价'
	        )
	      ),
	      React.createElement(
	        'div',
	        { className: 'content-block product-header-header' },
	        React.createElement(
	          'div',
	          { className: 'tabs' },
	          React.createElement(
	            'div',
	            { id: 'tab1', className: 'tab active' },
	            React.createElement(
	              'div',
	              { className: 'content-block slider-image-box' },
	              React.createElement(ProductShow, { data: product })
	            )
	          ),
	          React.createElement(
	            'div',
	            { id: 'tab2', className: 'tab' },
	            React.createElement(
	              'div',
	              { className: 'content-block product-header-header' },
	              React.createElement(
	                ...
	                React.createElement(
	                  'a',
	                  { href: '#tab4', className: 'tab-link active button' },
	                  '商品介绍'
	                ),
	                React.createElement(
	                  'a',
	                  { href: '#tab5', className: 'tab-link button' },
	                  '规格参数'
	                )
	              ),
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'div',
	                    { id: 'tab4', className: 'tab active' },
	                    React.createElement(
	                      'div',
	                      { className: 'content-block' },
	                      React.createElement('div', { style: { overflowX: 'hidden' }, dangerouslySetInnerHTML: { __html: product.product_info.introduction } })
	                    )
	                  ),
	                  React.createElement(
	                    'div',
	                    { id: 'tab5', className: 'tab' },
	                    React.createElement(
	                      'div',
	                      { className: 'content-block' },
	                      React.createElement('div', { style: { overflowX: 'hidden' }, dangerouslySetInnerHTML: { __html: product.product_info.primary_param } })
	                    )
	                  )
	                )
	              )
	...
	var ProductShow = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var slider_image = product.product_info.images_url.map(function (image_url) {
	      return React.createElement(
	        'div',
	        { key: image_url, className: 'swiper-slide w100' },
	        React.createElement('img', { className: 'w100', src: image_url })
	      );
	    });
	    return React.createElement(
	      'div',
	      { className: 'swiper-container swiper-container-cover silder-container-width' },
	      React.createElement(
	        'div',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { id: 'infinite', className: 'content infinite-scroll infinite-scroll-bottom mt10', 'data-distance': '500' },
	        React.createElement(ProductHeader, { data: this.state.data })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SliderList = React.createClass({
	  ...
	  render: function render() {
	    var commentNodes = this.props.data.map(function (slider) {
	      return React.createElement(
	        'div',
	        { key: slider.image_url, className: 'swiper-slide w100' },
	        React.createElement('img', { className: 'w100', src: Host + slider.image_url })
	      );
	    });
	    return React.createElement(
	      'div',
	...
	var SliderBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'swiper-container swiper-container-cover' },
	      React.createElement(SliderList, { data: this.state.data })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var supplier_data = [{ code: 'jd', name: '京东' }, { code: 'suning', name: '苏宁' }, { code: 'gome', name: '国美' }, { code: 'category', name: '分类' }, { code: 'leading', name: '领先未来' }, { code: 'office', name: '办公伙伴' }, { code: 'chenguang', name: '晨光' }, { code: 'more', name: '更多' }];
	...
	var SupplierList = React.createClass({
	  ...
	  render: function render() {
	    var supplierNodes = this.props.data.map(function (supplier) {
	      return React.createElement(
	        'a',
	        { key: supplier.code, href: "#/supplier/" + supplier.code },
	        React.createElement('img', { className: 'supplier_img', src: 'src/images/' + supplier.code + '.png' }),
	        React.createElement(
	          'span',
	          null,
	          supplier.name
	...
	var SupplierBox = React.createClass({
	  displayName: 'SupplierBox',

	  render: function render() {
	    return React.createElement(SupplierList, { data: supplier_data });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(215);
